...
object SerializationDocSpec {
  ...
  val configSpecific = """
    #//#specific-config
    pekko.serialization.jackson215.jackson-json {
      serialization-features {
        WRITE_DATES_AS_TIMESTAMPS = off
      }
    }
    pekko.serialization.jackson215.jackson-cbor {
      serialization-features {
  ...
  val configSeveral = """
    ...
    pekko.actor {
      serializers {
        jackson-json-message = "com.github.pjfanning.pekko.serialization.jackson215.JacksonJsonSerializer"
        jackson-json-event   = "com.github.pjfanning.pekko.serialization.jackson215.JacksonJsonSerializer"
      }
